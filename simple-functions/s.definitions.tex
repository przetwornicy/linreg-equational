...
\begin{definition}[Interface]
    The right and left interfaces of two simple functions $f, g: \sfarrow{A}{\Gamma}$ are simple functions with group output, of type $\sfarrowG{A}{\Gamma}$ given by the following definition.
...
\begin{definition}[Prefix compatible]
    We say that $f, g: \sfarrow{A}{\Gamma}$ are prefix-compatible if for every $\overline x : A$ we have $f(\overline x) \leq_\prefix g(\overline x)$ or $g(\overline x) \leq_\prefix f(\overline x)$.
\end{definition}
